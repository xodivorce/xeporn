# [Xporn - A Pornographical Website](https://github.com/xodivorce/xodivorce-portfolio/)

### Welcome to Xporn, a Web-platform of hosting Pornographical conatins; Coded by Prasid([@xodivorce](https://instagram.com/xodivorce)) & Souvik([@xcodespecter](https://instagram.com/xcodespecter)) ✨
...
[![version](https://img.shields.io/badge/version-v2.1.1-yellow.svg?style=flat)](https://github.com/xodivorce/xodivorce-portfolio/)
...
1. **Fork and Clone**:
   - Hit “Fork” at the top-right of the page to make your copy. Then clone it to your local machine:
     ```bash
     git clone git@github.com:xodivorce/xporn.git
     ```

2. **Set Up Your Local Playground**:
   - Move the project to your XAMPP `htdocs` folder:
     ```bash
     mv xporn /path/to/xampp/htdocs/
     ```
...
4. **View Locally**:
   - Open your browser and head to:
     ```bash
     http://localhost/xporn/htdocs/index.php
     ```
...
Don’t be shy! [*Open an issue*](https://github.com/xodivorce/xporn/issues) to discuss new features, enhancements, or any bugs you find. Your feedback is golden!!
...
A Pornographical Web Project - Crafted with ❤️ by **xodivorce & xcodespecter**